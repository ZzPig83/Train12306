...
import com.zzpig.train.business.domain.TrainCarriage;
...
import com.zzpig.train.business.domain.TrainSeat;
import com.zzpig.train.business.domain.TrainSeatExample;
import com.zzpig.train.business.mapper.TrainSeatMapper;
...
public class TrainSeatService {
    ...
    public void genTrainSeat(String trainCode) {
        ...
        for (TrainCarriage trainCarriage : carriageList) {
            ...
            // 根据车厢座位类型筛选出所有列，比如车箱类型是一等座，则筛选出columnList={ACDF}
