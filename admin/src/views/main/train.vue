<template>
    ...
    <template #bodyCell="{ column, record }">
      <template v-if="column.dataIndex === 'operation'">
        <a-space>
          ...
          <a-popconfirm title="将删除已有记录，确认生成座位？"
  ...
  <a-modal v-model:visible="visible" title="火车信息" @ok="handleOk" ok-text="确认" cancel-text="取消">
    <a-form :model="train" :label-col="{span: 4}" :wrapper-col="{span: 32}">
