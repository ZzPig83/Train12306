<template>
  ...
  <a-divider></a-divider>
  <b>勾选乘客：</b>&nbsp;
  <a-checkbox-group v-model:value="passengerChecks" :options="passengerOptions"></a-checkbox-group>
  <br/>
  ...
  <!--验证码-->
  <a-modal v-model:visible="imageCodeModalVisible" :title="null" :footer="null" :closeable="false"
...
export default defineComponent({
  ...
  setup() {
    ...
    const passengerOptions = ref([]); // 列表展示
    const passengerChecks = ref([]); // 勾选的值
