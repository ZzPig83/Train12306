package com.zzpig.train.${module}.service;
...
import com.zzpig.train.${module}.domain.${Domain};
import com.zzpig.train.${module}.domain.${Domain}Example;
import com.zzpig.train.${module}.mapper.${Domain}Mapper;
